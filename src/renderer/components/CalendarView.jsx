  ...
  return (
    <div className="view-pane active">
      <div className="bg-white/[0.015] border border-white/5 rounded-2xl p-6">
        ...
        <p className="text-[11px] sm:text-xs text-slate-400 mb-6 font-medium">Consulta el cronograma y plazos del curso actual.</p>
        ...
        {!courseSelected ? (
          ...
          <div className="text-center py-8 text-slate-500 text-[11px] sm:text-xs">Cargando fechas...</div>
