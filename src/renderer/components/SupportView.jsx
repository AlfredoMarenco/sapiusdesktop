  ...
  return (
    <div className="view-pane active">
      <div className="bg-white/[0.015] border border-white/5 rounded-2xl p-6 text-center max-w-lg mx-auto">
        ...
        <h2 className="text-lg font-bold text-white mb-2">Soporte Técnico Sapius</h2>
        ...
        <div className="bg-slate-900/60 border border-white/5 rounded-2xl p-6 text-left mb-6 space-y-4">
          <div>
            <span className="block text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-1">Horario de Atención</span>
            <p className="text-xs font-semibold text-slate-200">Lunes a Viernes: 9:00 AM - 6:00 PM</p>
          </div>
          <div>
            <span className="block text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-1">Contacto de WhatsApp</span>
            <p className="text-xs font-semibold text-slate-200">+52 1 999 364 8594</p>
          </div>
        </div>
        ...
        <a 
          ...
          target="_blank" 
          rel="noreferrer"
          className="inline-flex justify-center items-center py-3 px-6 bg-emerald-600 hover:bg-emerald-500 text-white rounded-xl text-xs font-bold transition-all shadow-md active:scale-98 text-decoration-none"
        >
